...
const sourcingListProductShape = {
  ...
  desiredRoiPercent: finiteNumber.min(0).max(10000).nullable().optional(),
  estimatedResaleFees: sourcingMoneySchema,
  estimatedResaleFeesCurrency: sourcingCurrencySchema,
