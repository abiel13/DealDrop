...
export const authRoutes = {
  ...
  creatorProfile: "/creator-profile" as Href,
  creator: "/creator" as Href,
...
export function creatorRoute(publicSlug: string) {
  return `/creator/${encodeURIComponent(publicSlug)}` as Href;
}
